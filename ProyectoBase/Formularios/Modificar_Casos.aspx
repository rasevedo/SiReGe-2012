                ...
                <div class="col-lg-12">                    
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label2" Text="Número de Caso" runat="server" />
                                ...
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label3" Text="Estado del Caso" runat="server" />
                                ...
                                <div class="col-md-3 col-md-offset-1" >
                                    <div class="form-group">
                                        <asp:Label ID="Label4" Text="Fecha de Caso*" runat="server"/>
                            ...
                            <div class="row">
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label5" Text="Cédula del Usuario" runat="server" />
                                ...
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label6" Text="Nombre del Usuario" runat="server" />
                            ...
                            <div class="row">
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label8" Text="Nombre del Centro Educativo" runat="server" />
                                ...
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label9" Text="Número de Oficio" runat="server"/>
                                ...
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label10" Text="Fecha de Oficio" runat="server"/>
                            ...
                            <div class="row">
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label11" Text="Condición del Caso" runat="server"  />
                            ...
                            <div class="row">
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label13" Text="Descripción Despacho" runat="server" />                                      
                                ...
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label14" Text="Descripción Dirección" runat="server" />
                                ...
                                <div class="col-md-3 col-md-offset-1" >
                                    <div class="form-group">
                                        <asp:Label ID="Label15" Text="Descripción Departamento" runat="server"/>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-md-offset-1" >
                                    <div class="form-group">
                                        <asp:Label ID="Label18" Text="Detalle Dimensión*" runat="server"/>
                            ...
                            <div class="row">
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label19" Text="Valoración de Admisibilidad" runat="server"  />
                                ...
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label20" Text="Veredicto de la Valoración de Ingreso" runat="server" />
                                ...
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label21" Text="Trazabilidad " runat="server" />
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label22" Text="Detalle de Inconformidad" runat="server" />                                       
                            ...
                            <div class="row">                              
                                <div class="col-md-12 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label23" Text="Respuesta del Caso" runat="server"/>
                            ...
                            <div class="row">
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label24" Text="Fecha de Respuesta" runat="server"/>
                                ...
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label25" Text="Fecha de Cierre" runat="server"/>
