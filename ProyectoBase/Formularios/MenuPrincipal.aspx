                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-md-offset-1">
                            ...
                            <div>
                                <asp:Label ID="Label1" Text="Atención de Gestiones del Servicio" runat="server" CssClass="centrar" />
                            </div>
                        </div>
                            <div class="col-md-3 col-md-offset-1">
                                <div class="form-group">              
                                ...
                                <div>
                                    <asp:Label ID="Label2" Text="Departamento de Atención al Usuario" runat="server" CssClass="centrar" />
                                </div>
                            </div> 
                            <div class="col-md-3 col-md-offset-1">
                                <div class="form-group">                                   
                                ...
                                <div>
                                    <asp:Label ID="Label3" Text="Departamento de Mejora Continua" runat="server" CssClass="centrar" />
                                </div>
                            </div>                       
                     </div>
                </div>
