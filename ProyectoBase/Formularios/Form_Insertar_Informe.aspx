                ...
                <div class="col-lg-12">                    
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label1" Text="Título del Informe" runat="server" />
                                ...
                                <div class="col-md-3 col-md-offset-1" >
                                    <div class="form-group">
                                        <asp:Label ID="Label3" Text="Tipo de Informe " runat="server"/>
                            ...
                            <div class="row">
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label4" Text="Número de oficio " runat="server"/>
                                ...
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label5" Text="Fecha de Aprobación" runat="server"/>
                            ...
                            <div class="row">                                
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label6" Text="Fecha de Culminación" runat="server"/>
                                        <asp:TextBox ID="txtfechaCulminacion" runat="server" TextMode="Date" Enabled="true" CssClass="form-control input-sm"  />
                                    </div>
                                </div>                            
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label7" Text="Fecha de Traslado" runat="server"/>
                            ...
                            <div class="row">                                
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label8" Text="Avance" runat="server"/>                              
