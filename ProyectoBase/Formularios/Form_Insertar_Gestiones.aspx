<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="Form_Insertar_Gestiones.aspx.vb" Inherits="CapPresentacionSiReGe.Form_Insertar_Gestiones" %>
                ...
                <div class="col-lg-12">                    
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label7" Text="Fuente Generadora*" runat="server" />
                            ...
                            <div class="row">                                
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label8" Text="Tipo de servicio*" runat="server" />
                                ...
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label9" Text="Dirección Regional de Educación" runat="server" />
...
GROUP BY tipoDimension"></asp:SqlDataSource>
                            ...
                            <div class="row">                              
                                <div class="col-md-12 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label23" Text="Respuesta" runat="server"/>
                                        <asp:TextBox runat="server" ID="txtrespuesta" TextMode="Multiline" Enabled="true" CssClass="form-control input-lg" Rows="5" Cols="12" />                                        
                                    </div>
                                </div>
                            </div>                        
