                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">                               
                                <div class="col-md-3 col-md-offset-5">
                                    <div class="form-group">
                                        <asp:Label ID="Label2" Text="Tipo de Gestión*" runat="server" />
                                        <br />
                                        <br />
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label7" Text="Confidencialidad" runat="server" />
                                ...
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label8" Text="Fuente Generadora*" runat="server" />
                            ...
                            <div class="row">                                
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label9" Text="Tipo de servicio*" runat="server" />
                                ...
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label10" Text="Dirección Regional de Educación" runat="server" />
                                ...
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label11" Text="Supervisión " runat="server" />
                            ...
                            <div class="row">
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label12" Text="Nombre del Centro Educativo" runat="server" />
                                ...
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label13" Text="Descripción Unidad" runat="server" />
                                ...
                                <div class="col-md-3 col-md-offset-1" >
                                    <div class="form-group">
                                        <asp:Label ID="Label14" Text="Número de Oficio " runat="server"/>
                            ...
                            <div class="row">
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label15" Text="Descripción Despacho" runat="server" />                                      
                                ...
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label16" Text="Descripción Dirección" runat="server" />
                                ...
                                <div class="col-md-3 col-md-offset-1" >
                                    <div class="form-group">
                                        <asp:Label ID="Label17" Text="Descripción Departamento" runat="server"/>
                            ...
                            <div class="row">
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label18" Text="Dimensión*" runat="server" />
                                        ...
                                        <asp:SqlDataSource runat="server" ID="SqlDataSource3" ConnectionString='<%$ ConnectionStrings:bda_SIREGE_Connection %>' SelectCommand="SELECT        tipoDimension
FROM            Dimensiones
GROUP BY tipoDimension"></asp:SqlDataSource>
                                ...
                                <div class="col-md-3 col-md-offset-1">
                                   <div class="form-group">
                                        <asp:Label ID="Label19" Text="Letra Dimensión*" runat="server" />
                                ...
                                <div class="col-md-3 col-md-offset-1" >
                                    <div class="form-group">
                                        <asp:Label ID="Label20" Text="Detalle Dimensión*" runat="server"/>
                            ...
                            <div class="row">
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label21" Text="Tipo de Usuario*" runat="server"  />
                                ...
                                <div class="col-md-3 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label22" Text="Categoría" runat="server" />
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label23" Text="Detalle*" runat="server" />                                       
                            ...
                            <div class="row">                              
                                <div class="col-md-12 col-md-offset-1">
                                    <div class="form-group">
                                        <asp:Label ID="Label24" Text="Respuesta" runat="server"/>
